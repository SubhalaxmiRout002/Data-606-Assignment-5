...
```{r}
proportion <- 1 - (4 / 50)
paste0("Proportion of your confidence intervals include the true population mean is ",proportion)
```
...
```{r}
# choose confidence = 90%, critical value = 1.65
set.seed(123)
n = 60
for (i in 1:50){
...
```{r}
propertion <- 1 - (7/50)
paste0("Proportion is ",propertion)
```
I can see all the propertion inteval include the true population mean is 0.86. The proportion level is 0.86 and the confidence level is 0.90. 
